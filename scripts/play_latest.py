...
Par défaut : le tout dernier run (toutes tâches confondues). Avec un flag de type, le dernier run de CE type seulement :
md-play --crouch      # dernier Mjlab-RollerCrouch-...     md-play --roller      # dernier Mjlab-...-Rollers     md-play
--swizzle     # dernier Mjlab-...-Swizzle-...     md-play --slope       # dernier Mjlab-RollerSlope-... Les arguments
inconnus sont transmis tels quels à `uv run play` (ex: md-play --crouch --action-scale 0.8).
"""
...
def main():
    """Find and play the latest wandb run matching a user/type filter."""
